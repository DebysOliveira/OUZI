...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
  <div>
    <img class="object-cover object-center w-full h-40 max-w-full cursor-pointer"
      src="images/bg1.jpg"
      alt="gallery-photo" onclick="openModal(0)"/>
  </div>
  <div>
    <img class="object-cover object-center w-full h-40 max-w-full cursor-pointer"
      src="images/bg2.jpg"
      alt="gallery-photo" onclick="openModal(1)"/>
  </div>
  <div>
    <img class="object-cover object-center w-full h-40 max-w-full cursor-pointer"
      src="images/bg3.jpg"
      alt="gallery-photo" onclick="openModal(2)"/>
  </div>
</div>
